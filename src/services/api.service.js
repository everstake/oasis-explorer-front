...
export default {
  ...
  getChartUptime: (params) => http.get(`chart/validator_stat/${encodeURIComponent(params.id)}`, { params }),
  getChartStake: (params) => http.get(`chart/balance/${encodeURIComponent(params.id)}`, { params }),
  getChartOperations: (params) => http.get('chart/operations/count', { params }),
